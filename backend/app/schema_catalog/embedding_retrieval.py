...
from app.schema_catalog.retrieval import _table_document
from app.schema_catalog.catalog_builder import CATALOG_DIR
    ...
    try:
        ...
        async def fetch_chunk(idx: int, chunk: list[str], client: httpx.AsyncClient):
            try:
                ...
                logger.debug(f"OpenAI-compatible chunk embedding call failed: {e}")
        ...
        logger.debug(f"OpenAI-compatible embedding call failed: {e}")
        return None
