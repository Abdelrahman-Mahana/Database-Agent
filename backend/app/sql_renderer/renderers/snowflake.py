...
class SnowflakeRenderer(DeterministicBaseRenderer):
    def __init__(self, ident_renderer, expr_renderer, proj_renderer, join_renderer, filter_renderer, group_renderer, order_renderer, limit_renderer, formatter):
        super().__init__(
            "snowflake", ident_renderer, expr_renderer, proj_renderer, join_renderer, filter_renderer, group_renderer, order_renderer, limit_renderer, formatter
        )
