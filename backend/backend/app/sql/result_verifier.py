...
class ResultVerifier:
    ...
    def verify(
        ...
        outcome.gate_statuses = {
            ...
            "result_cardinality": "FAIL" if outcome.cardinality_status == "cardinality_mismatch" else (
                "WARN" if outcome.cardinality_status == "unexpected_empty" else "PASS"
            ),
    ...
    def verify_and_constrain_prose(
        ...
        for sent in sentences:
            ...
            # without a semantic claim representation, so fail closed.
